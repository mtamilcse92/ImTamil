...
export default function Layout({ children }: LayoutProps) {
    return (
      <main className="flex bg-white flex-col dark:bg-zinc-900 flex-1 h-screen">
        ...
        <section className="flex flex-col bg-white dark:bg-zinc-900 md:flex-1 ">
            {children}
        </section>
        <div className="absolute bg-white flex-col dark:bg-zinc-900 bottom-0 text-right w-full">
